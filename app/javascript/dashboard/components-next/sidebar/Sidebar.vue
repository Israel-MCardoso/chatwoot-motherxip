    ...
    >
      ...
      >
        <RouterLink
          ...
          :to="{ name: 'search' }"
          class="flex gap-2 items-center px-2 py-1 w-full h-7 rounded-md outline outline-1 outline-n-weak bg-n-button-color transition-all duration-100 ease-out"
        >
        ...
        <RouterLink
          v-else
          :to="{ name: 'search' }"
          class="flex items-center justify-center size-8 rounded-md outline outline-1 outline-n-weak bg-n-button-color transition-all duration-100 ease-out hover:bg-n-alpha-2 dark:hover:bg-n-slate-9/30"
